    ...
    <div class="card">       
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered tabel-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @foreach ($tugas as $item)
                            ...
                            <td class="text-center">
                                ...
                                data-toggle="modal"
                                    data-target="#modalTugasShow{{ 
                                    $item->id }}">
                                    <i class="fas fa-eye"></i>
                                </button>
                                    <a href="{{ route('tugasEdit',
                                    $item->id) }}" class="btn btn-sm 
                                    btm-warning">
                                        <i class="fas fa-edit"></i>
                                </a>
                                <button class="btn btn-sm btn-danger"
                                data-toggle="modal"
                                    data-target="#modalTugasDestroy{{ 
                                    $item->id }}">
